...
class productoController{
    ...
    public static function index(){
        ...
        ?>
        <!-- Pequeña sección con JS para poder ejecutar el video con la imagen en vista previa encima -->
        <script>
        function playVideo() {
    ...
    public static function tienda(){
        ...
        if(isset($_SESSION['compra'])){
            if(isset($_POST['bocadillo'])){
                $productoSel = $listaBocadillos[$_POST['bocadillo']];
                $clave = $_POST['bocadillo'];
            }else if(isset($_POST['jamon'])){
                $productoSel = $listaJamones[$_POST['jamon']];
                $clave = $_POST['jamon'];
            }
            ...
            if(isset($productoSel)){
                if (!isset($_SESSION['usuario'])) {
                    ...
                    header('Location: http://localhost/restaurante/producto/login');
                }else{
                    if(isset($_SESSION['compra'][$clave])){
                        $_SESSION['compra'][$clave]->cantidad++;
                    }else{
